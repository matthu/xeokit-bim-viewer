...
import { SectionPlane } from '../sectionPlane/SectionPlane.js';
...
declare const ASSERT_OBJECT_STATE_UPDATE = false;

// Cached vars to avoid garbage collection

declare function getEntityIDMap(scene: any, entityIds: string[]): any;
...
export class Scene extends Component {
    ...
    _lightCreated(light: Light): void;
    ...
    _lightDestroyed(light: Light): void;
