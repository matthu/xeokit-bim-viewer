...
import { ViewerContent, ViewerInfo } from '../BIMViewer';
...
class ModelsExplorer extends Controller {
    ...
    loadProject(projectId: string, done: any, error: any) {
        this.server.getProject(projectId, (projectInfo: ViewerInfo) => {
            this.unloadProject();
    ...
    _parseProject(projectInfo: ViewerInfo, done: any) {
    ...
    _buildModelsMenu(projectInfo: ViewerInfo) {
        var html = "";
    ...
    _parseViewerConfigs(projectInfo: ViewerInfo) {
    ...
    _parseViewerContent(projectInfo: ViewerInfo, done: any) {
    ...
    _parseModelsLoaded(viewerContent: ViewerContent, done: any) {
    ...
    _loadNextModel(modelsLoaded: string[], done: any) {
    ...
    _parseViewerState(projectInfo: ViewerInfo, done: any) {
    ...
    loadModel(modelId: string, done?: any, error?: any) {
        if (!this._projectId) {
