...
class Server {
     ...
     */
    getProjects(done: any, error: any) {
     ...
     * @param {Function} error Callback through which an error message is returned on error.
     */
    getProject(projectId: string, done:any, error: any) {
     ...
     * @param {Function} error Callback through which an error message is returned on error.
     */
    getMetadata(projectId: string, modelId: string, done: any, error: any) {
     ...
     * @param {Function} error Callback through which an error message is returned on error.
     */
    getGeometry(projectId: string, modelId: string, done: any, error: any) {
     ...
     * @param {Function} error Callback through which an error message is returned on error.
     */
    getIssues(projectId: string, modelId: string, done: any, error: any) {
