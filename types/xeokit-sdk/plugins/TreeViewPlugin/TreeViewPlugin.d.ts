declare module '@xeokit/xeokit-sdk/src/plugins/TreeViewPlugin/TreeViewPlugin.js' {
    import {Plugin} from '@xeokit/xeokit-sdk/src/viewer/Plugin.js';
    /**
    ...
    */
    export class TreeViewPlugin extends Plugin {
         ...
         */
        withNodeTree(node: any, callback: Function): void;
        /**
